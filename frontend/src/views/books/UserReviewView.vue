...
import { ArrowLeft, Calendar, Star, Heart, MessageCircle, Share2, Send, Loader2, User } from 'lucide-vue-next'
      ...
      <template v-else-if="reviewData">
        ...
        <div class="mb-12">
          <div class="flex items-start gap-8">
            ...
            <div class="flex-1">
              ...
              <!-- Reviewer Card -->
              <div class="flex items-center gap-4 p-4 rounded-2xl bg-slate-900/50 border border-slate-800 mb-4">
                <div class="w-12 h-12 rounded-full bg-indigo-500/20 border border-indigo-500/30 flex items-center justify-center text-indigo-400 font-bold overflow-hidden">
                  <img
        ...
        <div class="rounded-3xl glass border-slate-800 p-12 bg-slate-900/30">
          ...
          <div v-else class="text-center py-12">
            <p class="text-slate-500 text-lg italic">This user hasn't written a review yet.</p>
          </div>
        </div>
