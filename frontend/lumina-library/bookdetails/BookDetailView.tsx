...
export const BookDetailView: React.FC<BookDetailViewProps> = ({ book, onBack, onToast }) => {
  // User Personal State
                  ...
                  <div className="space-y-6">
                    ...
                    <div>
                      ...
                      <textarea 
                        ...
                        placeholder="Napiši svoje utiske..."
                        className="w-full h-32 bg-slate-950/50 border border-slate-800 rounded-xl p-4 text-sm text-slate-200 placeholder-slate-600 focus:border-indigo-500 outline-none transition-all resize-none"
                      />
                    </div>
                  </div>
