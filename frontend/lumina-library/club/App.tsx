...
type View = 'importer' | 'quotes' | 'feed' | 'library' | 'my_shelf' | 'book_detail' | 'book_review' | 'vocabulary' | 'study_mode' | 'correspondence' | 'challenges' | 'nexum' | 'clubs';
    ...
    <div className="flex min-h-screen transition-colors duration-500 overflow-hidden bg-[var(--color-bg)]">
      ...
      <aside className="w-72 hidden lg:flex flex-col glass border-r border-[var(--color-border)] z-50 sticky top-0 h-screen bg-[var(--color-surface)] backdrop-blur-3xl">
        <div className="p-8">
          ...
          <nav className="space-y-1 overflow-y-auto custom-scrollbar max-h-[calc(100vh-200px)]">
            <NavGroup label="Main">
