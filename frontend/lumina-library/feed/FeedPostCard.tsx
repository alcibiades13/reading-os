...
import { 
  ...
  Quote as QuoteIcon, MessageSquare, TrendingUp, Star, MoreHorizontal 
} from 'lucide-react';
  ...
  return (
    <div className="group glass bg-slate-900/50 rounded-2xl border border-slate-800 p-6 hover:border-indigo-500/50 transition-all duration-300 animate-in fade-in slide-in-from-bottom-4 shadow-xl shadow-slate-950/20">
      ...
      <div className="flex gap-6 mb-6">
        {/* Book Cover */}
        {post.book.cover && (
          <div className="hidden sm:block shrink-0 w-[80px] h-[120px] rounded-lg overflow-hidden shadow-2xl ring-1 ring-white/10 group-hover:scale-105 transition-transform duration-300">
        ...
        <div className="flex-1 min-w-0">
          <div className="mb-3">
            <h3 className="text-lg font-bold text-slate-100 group-hover:text-indigo-400 transition-colors cursor-pointer truncate">
              {post.book.title}
            </h3>
