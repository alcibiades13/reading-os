...
import { 
  ...
  PenTool, CircleUser, Waves, Timer
} from 'lucide-react';

type View = 'importer' | 'quotes' | 'feed' | 'library' | 'my_shelf' | 'book_detail' | 'book_review' | 'vocabulary' | 'study_mode' | 'correspondence' | 'challenges' | 'nexum' | 'clubs' | 'aethel' | 'codex' | 'author_detail' | 'friends';
